...
| `insta --agent storage set-access <public\|private>` [`--service <name>`] [`--branch <b>`] [`--json`] | set the bucket's whole-bucket access mode — `public` (anonymous public-read) or `private` (the default) |
